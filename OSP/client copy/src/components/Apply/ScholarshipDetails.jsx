...
const ScholarshipDetails = () => {
  ...
  const {
    ...
    ispending,
    error,
  } = useFetch("http://localhost:8000/scholarships/" + id);
      ...
      {scholarships && (
        <div className="details-container">
          ...
          <div className="scholarship-info">
            ...
            <ul>
              <li>
                Education Level: {scholarships.eligibility.education_level}
              </li>
              <li>
                Eligible Courses:{" "}
                {scholarships.eligibility.eligible_courses.join(", ")}
              </li>
              <li>
                Minimum Percentage: {scholarships.eligibility.min_percentage}%
              </li>
              <li>
                Annual Family Income: ₹{" "}
                {scholarships.eligibility.annual_family_income}
              </li>
            </ul>
