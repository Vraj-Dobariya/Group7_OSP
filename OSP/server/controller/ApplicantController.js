...
const getListOfScholarships = async (req, res) => {
  console.log("In application controller, fetching getListofScholarships");
  try {
    const query = `
      SELECT 
      ...
      GROUP BY 
        s.scholarship_id, s.scholarship_name
      ORDER BY 
        s.scholarship_id;
    `;
...
module.exports = {
    getListOfScholarships,getApplicantsByScholarshipId
  };